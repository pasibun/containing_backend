...
/**
 * Checks wether a second has passed in real life and sets the simulation time according to the SECOND_MULTIPLIER constant value
 * 
 * 1 hour in our project takes about 24 seconds
 * Therefore 1 day in our project = 9.6 Minutes
 * 
 */
